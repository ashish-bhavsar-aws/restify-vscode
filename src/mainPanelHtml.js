...
.gear-btn {
  ...
  border: none;
  /* Making it brighter: using editor foreground or white instead of muted */
...
.gear-btn:hover {
  ...
  opacity: 1;
  color: var(--accent); /* Optional: turns blue/accent color on hover */
}
...
<div class="top-bar">
  ...
  <button class="gear-btn" title="Open Settings" onclick="vscode.postMessage({ command: 'openSettings' })">
