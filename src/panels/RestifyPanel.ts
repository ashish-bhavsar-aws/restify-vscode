...
export class RestifyPanel {
  ...
  /** F50: sink for the HTTP-log interceptor. */
  private httpLogChannel: vscode.OutputChannel | null = null;
  ...
  constructor(
    ...
    this.panel.onDidDispose(() => {
      ...
      this.httpLogChannel?.dispose();
      this.httpLogChannel = null;
    ...
    this.requestExecutor = new RequestExecutor({
      ...
      logLine: (line) => {
        this.httpLogChannel ??= vscode.window.createOutputChannel("Restify: HTTP Log");
        this.httpLogChannel.appendLine(line);
      },
    });
